...
class Message(Object):
    def __init__(self, mid=None, seq=None, attachments: list=None, text=None, is_echo=None, app_id=None, quick_reply=None):
        self.mid = mid
        self.seq = seq
        self.text = text
...
class Messaging(Object):
    def __init__(self, sender, recipient, timestamp, message: Message, read=None, postback=None, delivery=None):
        self.sender = sender
